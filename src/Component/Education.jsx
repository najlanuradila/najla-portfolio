...
function Edu({ university, major, gpa, duration }) {
  return (
    <article className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      <div className="flex justify-between items-center">
        <h1 className="text-content md:text-lg lg:text-xl">{university}</h1>
        <div className="btn bg-white text-[#775625] text-xs inline-block rounded-3xl px-3 py-1 min-w-fit">
          {gpa}
        </div>
      </div>
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-content text-xs md:text-sm font-light pl-1">{major}</p>
          </div>
        </div>
