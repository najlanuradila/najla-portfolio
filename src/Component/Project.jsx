...
function Project({ title, description, techstack, image, feature, deploy, previewLink, githubLink }) {
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900">
      <div className="dark:bg-dark-card p-4">
        <h1 className="dark:text-light-heading font-bold text-xl pt-1 text-center">{title}</h1>
        {image && (
          <img
            src={image}
            alt={title}
        ...
        <h3 className="text-dark-heading dark:text-light-heading font-medium ">
          Feature : <span className="font-light">{feature}</span>
        </h3>
        <h3 className="text-dark-heading dark:text-light-heading font-medium ">
          Deployment : <span className="font-light">{deploy}</span>
        </h3>
        <h3 className="text-dark-heading dark:text-light-heading font-medium ">
